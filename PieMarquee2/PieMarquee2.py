...
## Full screen for Pi4 hdmi1 ( Supreme Edit )
VIEWER = "/opt/retropie/configs/all/PieMarquee2/omxiv-marquee /tmp/marquee.txt -a fill -f -b -d 7 -t 5 -T blend --duration 900 > /dev/null 2>&1 &"
